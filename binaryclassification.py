...
if __name__ == "__main__":
    ...
    for iteration, (train_index, test_index) in enumerate(kf.split(indexes)):
        ...
        np.savetxt('binaryclassification_results/preds.txt', preds, fmt='%.4e', delimiter=' ', newline='\n')
        np.savetxt('binaryclassification_results/classes.txt', classes, fmt='%s', delimiter=' ', newline='\n')