...
class Feature_Creator:
    ...
    def __init__(self, fit_structure, structures_df, path):   
    ...
    def run_orbital_field_matrix_featurizer(self, mode):
        ...
        ofm_featurizer_result = ofm_featurizer.featurize_many(self.structures_df[self.mode], ignore_errors=False)
        print(ofm_featurizer_result)
